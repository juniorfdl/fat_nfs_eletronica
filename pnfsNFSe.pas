...
//    property Quantidade: Integer read FQuantidade write FQuantidade;
 ...
 TIdentificacaoPrestador = class(TPersistent)
  ...
  TDadosProdutos = Class(TPersistent)
  private
    fTotal: Currency;
 ...
 TDadosParcelas = Class(TPersistent)
  private
    fValor: Currency;
    fNumero: Integer;
 ...
 TEndereco = class(TPersistent)
  ...
  published
    ...
    property xMunicipio_Incidencia: String read FxMunicipio_Incidencia write FxMunicipio_Incidencia;
  end;
 ...
 TNFSe = class(TPersistent)
  private
    ...
    fListaDadosParcelas: TListaDadosParcelas;
    fListaDadosProdutos: TListaDadosProdutos;
  ...
  published
    ...
    property ListaDadosParcelas:TListaDadosParcelas read fListaDadosParcelas write fListaDadosParcelas;
    property ListaDadosProdutos:TListaDadosProdutos read fListaDadosProdutos write fListaDadosProdutos;
  end;
